  ...
  data() {
    return {
      products: [
        ...
        color:'green',
        bgText:'NIKE',
        src:require('./assets/green-shoes.png')
        },
        {
        title: 'Nike flex',
        color:'blue',
        bgText:'AIR',
        src:require('./assets/blue-shoes.png')
        },
        {
        title: 'Nike Roche Runs',
        color:'pink',
        bgText:'MAX',
        src:require('./assets/pink-shoes.png')
        }
      ]
    }
  },
  methods: {
    mousemove(e){
      ...
      for(let i= 0; i < products.length; i++){
          ...
          product_image.style.transform = `translateY(-${img_y/20}px) translateX(-${img_x/20}px)
          translateZ(100px)`;
